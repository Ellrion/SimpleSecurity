...
class OldSecurityService
{
    ...
    private function checkAccessLevel(&$accessLevel, $user, $prop = [])
    {
    ...
    private function checkAccessRule(&$accessRule, $user, $prop = [])
    {
    ...
    private function checkAccessRole(&$accessRole, $user, $prop = [])
    {
        ...
        if (strpos($accessRole, ':')) {
            ...
            $prop = array_merge($prop, [$role_parts[0]=>$role_parts[1]]);
            return $this->prepareAccessLevel(
                $accessRole
                , $this->checkAccessLevel($this->cachedRolesList[$accessRole], $user, $prop)
            );
    ...
    private function checkAccessStrategy(&$accessStrategy, $user, $prop = [])
    {
